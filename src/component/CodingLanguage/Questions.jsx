...
const Questions = {
    Html: [
        { id: 1, text: 'What is the correct HTML tag for inserting an image?', options: ['<img>', '<image>', '<pic>', '<photo>'], answer: '<img>' },
        { id: 2, text: 'Which HTML attribute is used to define inline styles?', options: ['style', 'css', 'class', 'font'], answer: 'style' },
        { id: 3, text: 'Which HTML element is used to specify a description list?', options: ['<dl>', '<list>', '<desc>', '<ul>'], answer: '<dl>' },
        { id: 4, text: 'How do you specify alternative text for an image?', options: ['alt', 'title', 'src', 'description'], answer: 'alt' },
        { id: 5, text: 'What does the <strong> tag do?', options: ['Makes text bold', 'Underlines text', 'Italicizes text', 'Creates a header'], answer: 'Makes text bold' },
        { id: 6, text: 'What is the purpose of the <em> tag?', options: ['Emphasizes text', 'Increases font size', 'Creates a link', 'Defines a header'], answer: 'Emphasizes text' },
        { id: 7, text: 'How do you create a radio button in HTML?', options: ['<input type="radio">', '<radio>', '<input type="button">', '<input radio="true">'], answer: '<input type="radio">' },
        { id: 8, text: 'Which element is used to define the document type in HTML?', options: ['<!DOCTYPE>', '<html>', '<doc>', '<doctype>'], answer: '<!DOCTYPE>' },
        { id: 9, text: 'Which tag is used to create a line horizontally across the page?', options: ['<hr>', '<line>', '<break>', '<separator>'], answer: '<hr>' },
        { id: 10, text: 'What is the purpose of the <abbr> tag?', options: ['Defines an abbreviation', 'Creates a header', 'Underlines text', 'Displays an image'], answer: 'Defines an abbreviation' },
        { id: 11, text: 'Which tag is used to define an address element?', options: ['<address>', '<location>', '<addr>', '<section>'], answer: '<address>' },
        { id: 12, text: 'How do you define a title for a table column?', options: ['<th>', '<tr>', '<td>', '<title>'], answer: '<th>' },
        { id: 13, text: 'What does the <b> tag do?', options: ['Makes text bold', 'Emphasizes text', 'Creates a link', 'Defines a section'], answer: 'Makes text bold' },
        { id: 14, text: 'Which tag defines the main content of an HTML document?', options: ['<main>', '<section>', '<body>', '<div>'], answer: '<main>' },
        { id: 15, text: 'How do you create a multi-line text input?', options: ['<textarea>', '<input type="text">', '<text>', '<multiline>'], answer: '<textarea>' },
        { id: 16, text: 'What is the correct HTML element for underlining text?', options: ['<u>', '<underline>', '<text-decoration>', '<under>'], answer: '<u>' },
        { id: 17, text: 'Which tag is used to specify the document’s header?', options: ['<header>', '<head>', '<top>', '<section>'], answer: '<header>' },
        { id: 18, text: 'How do you define a clickable image in HTML?', options: ['Wrap the <img> tag inside <a>', 'Add a src attribute', 'Define a URL in the <img>', 'Use <clickable-img>'], answer: 'Wrap the <img> tag inside <a>' },
        { id: 19, text: 'Which tag is used to represent the output of a calculation?', options: ['<output>', '<calc>', '<value>', '<result>'], answer: '<output>' },
        { id: 20, text: 'What does the <s> tag do?', options: ['Strikes through text', 'Underlines text', 'Emphasizes text', 'Changes text color'], answer: 'Strikes through text' },
        { id: 21, text: 'How do you define a comment in HTML?', options: ['<!-- comment -->', '<comment>', '<!comment>', '<-- comment -->'], answer: '<!-- comment -->' },
        { id: 22, text: 'What is the correct HTML for making a dropdown menu?', options: ['<select>', '<dropdown>', '<menu>', '<list>'], answer: '<select>' },
        { id: 23, text: 'Which HTML tag is used to italicize text?', options: ['<i>', '<italic>', '<em>', '<italics>'], answer: '<i>' },
        { id: 24, text: 'How do you add a video file to an HTML page?', options: ['<video src="file">', '<movie>', '<embed src="file">', '<media src="file">'], answer: '<video src="file">' },
        { id: 25, text: 'What is the purpose of the <kbd> tag?', options: ['Defines keyboard input', 'Creates a button', 'Makes text bold', 'Creates a header'], answer: 'Defines keyboard input' },
        { id: 26, text: 'Which HTML element is used to display a date/time?', options: ['<time>', '<datetime>', '<date>', '<timestamp>'], answer: '<time>' },
        { id: 27, text: 'How do you include a CSS file in HTML?', options: ['<link rel="stylesheet" href="file.css">', '<css link="file.css">', '<style src="file.css">', '<css src="file.css">'], answer: '<link rel="stylesheet" href="file.css">' },
        { id: 28, text: 'What does the <small> tag do?', options: ['Makes text smaller', 'Emphasizes text', 'Adds a link', 'Underlines text'], answer: 'Makes text smaller' },
        { id: 29, text: 'How do you specify a default value for a <select> dropdown?', options: ['<option selected>', '<default>', '<selected>', '<value="default">'], answer: '<option selected>' },
        { id: 30, text: 'Which HTML element is used to mark text that is inserted?', options: ['<ins>', '<insert>', '<add>', '<put>'], answer: '<ins>' }
    ]
    ,
    css: [
    ...
    sql: [
        ...
        { id: 1, text: 'What is the virtual DOM in React?', options: ['A lightweight copy of the real DOM', 'A physical part of the DOM', 'A JavaScript framework', 'A React component'], answer: 'A lightweight copy of the real DOM' },
        { id: 2, text: 'What is the purpose of the React key prop in lists?', options: ['To provide a unique identifier for each item', 'To set the index of each item', 'To handle events', 'To manage state'], answer: 'To provide a unique identifier for each item' },
        { id: 3, text: 'How does React handle updates to the virtual DOM?', options: ['It calculates the difference and updates only the changed parts', 'It re-renders the entire DOM', 'It uses a timer to update', 'It clears the DOM and re-creates it'], answer: 'It calculates the difference and updates only the changed parts' },
        { id: 4, text: 'What is the purpose of prop-types in React?', options: ['To enforce type checking on props', 'To manage component state', 'To handle side effects', 'To add CSS classes'], answer: 'To enforce type checking on props' },
        { id: 5, text: 'What is a pure component?', options: ['A component that only re-renders when its props or state change', 'A component without props', 'A component with a single render', 'A component that is stateless'], answer: 'A component that only re-renders when its props or state change' },
        { id: 6, text: 'How do you update the state in React?', options: ['By using the setState function', 'By directly modifying the state object', 'By using the state function', 'By re-rendering the component'], answer: 'By using the setState function' },
        { id: 7, text: 'What does the componentWillUnmount lifecycle method do?', options: ['It runs before a component is removed from the DOM', 'It runs after the component is mounted', 'It updates the state', 'It handles side effects'], answer: 'It runs before a component is removed from the DOM' },
        { id: 8, text: 'What is lazy loading in React?', options: ['Loading components only when needed', 'Loading all components at once', 'Using hooks to manage state', 'Loading state data in a specific order'], answer: 'Loading components only when needed' },
        { id: 9, text: 'What is error boundary in React?', options: ['A component that catches JavaScript errors', 'A boundary for lifecycle methods', 'A state hook', 'A library for managing errors'], answer: 'A component that catches JavaScript errors' },
        { id: 10, text: 'What is React Portals?', options: ['A way to render children into a DOM node outside of the parent component', 'A method to load images', 'A type of higher-order component', 'A special hook'], answer: 'A way to render children into a DOM node outside of the parent component' },
        { id: 11, text: 'How do you prevent unnecessary re-renders in React?', options: ['By using React.memo', 'By adding more state', 'By using componentDidUpdate', 'By using hooks only'], answer: 'By using React.memo' },
        { id: 12, text: 'What is the purpose of React.PureComponent?', options: ['To optimize rendering by performing a shallow comparison of props and state', 'To manage component props', 'To handle routing', 'To create refs'], answer: 'To optimize rendering by performing a shallow comparison of props and state' },
        { id: 13, text: 'How does React handle form submissions?', options: ['By preventing the default browser behavior', 'By reloading the page', 'By redirecting to another page', 'By handling routing'], answer: 'By preventing the default browser behavior' },
        { id: 14, text: 'What is code-splitting?', options: ['A technique for dividing code into smaller chunks', 'Loading components at once', 'Adding comments in code', 'A debugging technique'], answer: 'A technique for dividing code into smaller chunks' },
        { id: 15, text: 'What is the purpose of the React Profiler?', options: ['To measure the performance of React components', 'To manage component state', 'To create components', 'To render HTML'], answer: 'To measure the performance of React components' },
        { id: 16, text: 'How do you create a reference to a DOM element in React?', options: ['By using the useRef hook', 'By using the useEffect hook', 'By adding an id attribute', 'By using setState'], answer: 'By using the useRef hook' },
        { id: 17, text: 'What does React.StrictMode do?', options: ['It helps detect potential problems in an application', 'It optimizes the application', 'It provides state management', 'It renders elements faster'], answer: 'It helps detect potential problems in an application' },
        { id: 18, text: 'What is a controlled component in React?', options: ['A component that gets its value from state', 'A component without state', 'A component that doesn’t re-render', 'A component used only for events'], answer: 'A component that gets its value from state' },
        { id: 19, text: 'What is the Context API used for?', options: ['To pass data through the component tree without props', 'To handle events', 'To style components', 'To manage API requests'], answer: 'To pass data through the component tree without props' },
        { id: 20, text: 'How does useCallback help in React?', options: ['It memoizes a function to avoid re-creating it on each render', 'It fetches data from an API', 'It optimizes CSS', 'It handles form inputs'], answer: 'It memoizes a function to avoid re-creating it on each render' },
        { id: 21, text: 'How do you add default values in React props?', options: ['Using defaultProps', 'Using setState', 'Using componentDidMount', 'Using useEffect'], answer: 'Using defaultProps' },
        { id: 22, text: 'What is React Concurrent Mode?', options: ['A feature for handling multiple tasks simultaneously', 'A hook to manage data', 'A styling feature', 'A routing tool'], answer: 'A feature for handling multiple tasks simultaneously' },
        { id: 23, text: 'What does the useTransition hook do?', options: ['Allows certain updates to be deferred for a smoother UI', 'Fetches data', 'Creates a timeout', 'Handles routing'], answer: 'Allows certain updates to be deferred for a smoother UI' },
        { id: 24, text: 'What is the purpose of the useMemo hook?', options: ['To memoize expensive calculations', 'To manage state', 'To handle API requests', 'To fetch data from a server'], answer: 'To memoize expensive calculations' },
        { id: 25, text: 'What is React.lazy?', options: ['A function for code-splitting components', 'A hook for managing state', 'A lifecycle method', 'A way to handle animations'], answer: 'A function for code-splitting components' },
        { id: 26, text: 'What is the difference between React and React Native?', options: ['React is for web, React Native is for mobile', 'React is for server-side, React Native is for client-side', 'Both are the same', 'React Native is faster than React'], answer: 'React is for web, React Native is for mobile' },
        { id: 27, text: 'How do you handle side effects in functional components?', options: ['Using useEffect', 'Using setState', 'Using React Router', 'Using lifecycle methods'], answer: 'Using useEffect' },
        { id: 28, text: 'What is an async component in React?', options: ['A component that loads asynchronously to improve performance', 'A component that handles form submissions', 'A component that runs faster', 'A component that fetches data'], answer: 'A component that loads asynchronously to improve performance' },
        { id: 29, text: 'How do you handle errors in rendering in React?', options: ['Using error boundaries', 'Using try-catch', 'Using setState', 'Using Redux'], answer: 'Using error boundaries' },
        { id: 30, text: 'What is React’s useDeferredValue hook?', options: ['To defer updates and improve responsiveness', 'To fetch data from a server', 'To create default props', 'To handle routing'], answer: 'To defer updates and improve responsiveness' },
    ]
,    
    C:[
